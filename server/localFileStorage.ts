...
export class LocalFileStorageService {
  ...
  // Get file for entity
  async getObjectEntityFile(objectPath: string): Promise<{ exists: boolean; path: string; buffer?: Buffer; download: () => Promise<[Buffer]>; getMetadata: () => Promise<[{ contentType: string; size: number }]> }> {
