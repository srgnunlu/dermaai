      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-16">
          ...
          <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow bg-white/80 dark:bg-gray-800/80 backdrop-blur" data-testid="card-feature-history">
            ...
            <CardContent>
              <CardDescription>
                Track and review all previous cases with complete analysis history and patient
                information
              </CardDescription>
            </CardContent>
          </Card>
          ...
          <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow bg-white/80 dark:bg-gray-800/80 backdrop-blur" data-testid="card-feature-patient">
            ...
            <CardContent>
              <CardDescription>
                Efficiently manage patient records with detailed medical history and demographic
                information
              </CardDescription>
            </CardContent>
          </Card>
          ...
          <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow bg-white/80 dark:bg-gray-800/80 backdrop-blur" data-testid="card-feature-urgent">
            ...
            <CardContent>
              <CardDescription>
                Automatically identifies conditions requiring immediate medical attention with clear
                visual indicators
              </CardDescription>
            </CardContent>
          </Card>
