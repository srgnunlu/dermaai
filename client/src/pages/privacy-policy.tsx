    ...
    <div className="min-h-screen bg-background flex flex-col">
      <main className="flex-1">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <h1 className="mt-4 text-4xl font-bold text-foreground">Protecting Clinical and Patient Privacy</h1>
          <p className="mt-4 text-lg text-muted-foreground leading-relaxed">
            DermaAI is designed for regulated clinical environments. We only collect the information required to deliver secure dermatological decision support and never use patient-identifiable data for marketing or third-party analytics.
          </p>
          ...
          <div className="mt-12 rounded-2xl border border-blue-500/30 bg-blue-500/5 p-6 text-sm text-blue-100">
            ...
            <p className="mt-2">
              Email our Data Protection Officer at <a href="mailto:privacy@dermaai.health" className="underline">privacy@dermaai.health</a>. We respond to verified requests within 72 hours.
            </p>
          </div>
        </div>
      </main>
