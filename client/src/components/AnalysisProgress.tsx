  ...
  useEffect(() => {
    ...
    const progressInterval = setInterval(() => {
      ...
      const currentProgress =
        stage.startPercent + (stage.endPercent - stage.startPercent) * stageProgress;
      ...
      <CardContent className="p-6 space-y-6">
        ...
        <div className="text-center space-y-2">
          <div className="flex items-center justify-center space-x-2">
            <div className="animate-pulse">{currentStage.icon}</div>
            <h3 className="text-lg font-semibold text-foreground">AI Analizi Devam Ediyor</h3>
          </div>
        ...
        <div className="bg-white/50 dark:bg-gray-800/50 rounded-lg p-4 border border-blue-100 dark:border-blue-900">
          <div className="flex items-center space-x-3">
            <div className="animate-bounce">{currentStage.icon}</div>
        ...
        <div className="text-center p-3 bg-gradient-to-r from-blue-100 to-purple-100 dark:from-blue-900/30 dark:to-purple-900/30 rounded-lg border border-blue-200 dark:border-blue-800">
          <p className="text-sm text-muted-foreground">
            Tahmini kalan süre:{' '}
            <span className="font-semibold text-primary">{timeRemaining} saniye</span>
          </p>
