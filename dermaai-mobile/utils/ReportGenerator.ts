...
export const generateReportHtml = ({ caseData, language }: ReportGeneratorProps): string => {
    ...
    // Translations
    const t = {
        reportTitle: isTr ? 'Cilt Farkındalık Raporu' : 'Skin Awareness Report',
        ...
        confidence: isTr ? 'Model Güven Skoru' : 'Model Confidence Score',
        keyFeatures: isTr ? 'Temel Bulgular' : 'Key Findings',
        recommendations: isTr ? 'Öneriler' : 'Recommendations',
        disclaimer: isTr
            ? 'Bu rapor yapay zeka destekli bir farkındalık ve ön değerlendirme raporudur. Sağlık kararları için bir dermatoloğa danışın.'
            : 'This is an AI-assisted awareness and preliminary assessment report. Consult a dermatologist for healthcare decisions.',
        generatedBy: isTr ? 'Rapor Oluşturan' : 'Report Generated By',
        footer: 'Corio Scan - AI-Assisted Skin Awareness'
    };
...
<body>
    <div class="header">
        <h1 class="logo-text">Corio Scan</h1>
        <div class="sub-logo">AI-Assisted Skin Awareness</div>
    ...
    <div class="footer">
        ...
        <div class="signature">Corio Scan</div>
        ...
        <div style="font-size: 10px; color: #ccc; margin-top: 20px;">
            ${new Date().getFullYear()} © Corio Scan. All rights reserved.
        </div>
    </div>
</body>
</html>
